...
export function DockRail({
  ...
  return (
    <aside
      ...
      className="dock-surface fixed right-0 top-1/2 -translate-y-1/2 z-50 flex flex-col items-center w-[56px] py-3 px-2 rounded-l-2xl rounded-r-none border-r-0 select-none pointer-events-auto"
    >
